 ...
 * @author scr2
 */
@WebServlet(name="HistoryHomeServlet", urlPatterns={"/HistoryHomeServlet"})
public class HistoryHomeServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XSLFileName = path + "/historyhome.xsl";
